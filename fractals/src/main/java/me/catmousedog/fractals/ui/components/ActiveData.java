 ...
 * the actual event should be implemented through {@link ActiveData#concreteEvent(EventObject)}
 * <p>
 ...
 */
public abstract class ActiveData<T> extends Data<T> implements Savable {
