...
public class TestFractal extends MouseFractal {
	...
	static {
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(6.313051, -2.141247));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.163747, -0.034806));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.473519, -6.462078));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-10.217641, -13.138242));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.975073, 2.422910));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.801179, 0.336259));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.029548, 0.945526));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.311775, 3.121210));
		regions.get(regions.size() - 1).coefficients.add(new Complex(10.546667, -5.607041));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.801936, -0.482661));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.257419, -0.900968));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.160887, 0.450484));
		/*
		 * ----------------------------------- L -----------------------------------
		 */
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.336380, -0.124403));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.217361, -11.302144));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.215850, -11.029263));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.954182, -10.915049));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.596704, -10.764859));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.051963, -10.740573));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.427528, -11.110506));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.740038, -10.919014));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.031280, -11.669563));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.194257, -11.598482));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.919256, -12.186717));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.103331, -12.204272));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.253498, -12.540740));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.334360, -12.450689));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.859880, -12.310126));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.550564, -12.438815));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.213441, -11.744414));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.461401, -11.131016));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.894525, -9.883058));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.312626, -8.813070));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.716945, -8.236966));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.088621, -8.000231));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.924771, -8.184952));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.572240, -8.037613));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.367518, -8.037599));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.789104, -8.389909));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.698199, -8.211567));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.489734, -8.616086));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.643205, -8.488897));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.121768, -8.566620));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-5.035557, -8.472260));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-4.119547, -8.250729));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-3.556055, -8.072373));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.875837, -7.823314));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.785596, -8.063063));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-2.299776, -8.060771));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.493634, -8.948549));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.123946, -9.685953));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.231057, -9.242808));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.825936, -10.040138));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.750297, -9.950476));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.203221, -10.283491));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.347721, -10.182021));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.083684, -10.035305));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.016663, -10.098816));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.057197, -9.657989));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.371745, -9.317375));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.815861, -9.127135));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.144166, -8.952685));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.406752, -8.269537));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.389445, -8.466397));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.851100, -8.050262));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-1.056310, -8.156987));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.250739, -8.233416));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.467295, -8.212626));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.203660, -8.612678));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.085972, -8.580486));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.807091, -9.217209));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.589398, -8.696953));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.754193, -8.502120));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(1.383503, -9.337905));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(1.024390, -8.936758));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.065686, -9.729461));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(1.735983, -9.518878));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.271960, -9.396754));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.509251, -9.451852));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.384208, -8.871582));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.288197, -9.124414));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.442800, -8.232387));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.493588, -8.417660));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.005256, -8.352102));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(2.828629, -8.295494));
		...
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.189415, -8.578773));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.532058, 0.017471));
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.616366, -8.948549));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.281401, -0.107923));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.054180, -0.011112));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.312778, 0.089962));
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.986054, -9.685953));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.066556, -0.095493));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.017362, -0.005787));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.183609, 0.079830));
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.878943, -9.242808));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.083821, -0.041911));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.049894, -0.015966));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.233839, 0.219442));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.284064, -10.040138));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.086996, -0.127956));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.018668, 0.016254));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.250592, 0.133450));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.359703, -9.950476));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.091933, -0.117362));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.003912, -0.050857));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.011956, -0.017165));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.035049, -0.280729));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.906779, -10.283491));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.022887, 0.160473));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.015698, -0.021125));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.069889, 0.146820));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.762279, -10.182021));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.033448, -0.061615));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.008802, -0.045771));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.260874, -0.040027));
		regions.get(regions.size() - 1).coefficients.add(new Complex(5.193684, -10.035305));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.112251, 0.026180));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.016044, -0.020055));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.193638, -0.029046));
		regions.get(regions.size() - 1).coefficients.add(new Complex(5.093337, -10.098816));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.048410, -0.012448));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.088520, -0.017981));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.271255, 0.197656));
		regions.get(regions.size() - 1).coefficients.add(new Complex(5.052803, -9.657989));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.141024, -0.097857));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.017219, 0.008909));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.004053, 0.012159));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.219237, 0.259442));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.738255, -9.317375));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.113690, -0.152474));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.023278, -0.003320));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.007897, -0.007773));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.140011, 0.290852));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.294139, -9.127135));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.077784, -0.185850));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.029169, 0.067224));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.074692, 0.277811));
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.965834, -8.952685));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.028909, -0.171126));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.001308, 0.013081));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.004186, -0.017164));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.245459, -0.277789));
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.703248, -8.269537));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.124198, 0.106880));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.054770, 0.005552));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.017242, 0.003676));
		...
		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.232486, -0.067925));
		regions.get(regions.size() - 1).coefficients.add(new Complex(3.720555, -8.466397));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.048698, 0.017190));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.104934, 0.039988));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.001474, -0.331289));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.258900, -8.050262));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.059555, 0.211462));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.017427, 0.017193));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.049933, -0.141914));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.053690, -8.156987));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.027594, 0.078841));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.011826, 0.036792));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.200966, 0.233540));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.859261, -8.233416));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.086344, -0.183747));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.017061, 0.006230));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.038340, -0.146259));
		regions.get(regions.size() - 1).coefficients.add(new Complex(4.642705, -8.212626));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.046860, 0.083780));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.014200, 0.024140));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.224676, 0.127756));
		regions.get(regions.size() - 1).coefficients.add(new Complex(5.313660, -8.612678));
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.109543, -0.126463));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.001980, 0.020472));

		regions.add(new Region());
		regions.get(regions.size() - 1).coefficients.add(new Complex(-0.092465, -0.114834));
		regions.get(regions.size() - 1).coefficients.add(new Complex(5.195972, -8.580486));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.078764, 0.074703));
		regions.get(regions.size() - 1).coefficients.add(new Complex(0.014772, 0.013295));

		Complex globalShift = new Complex(0, 0);
		boolean first = true;
		for (Region r : regions) {
			// global shift
			if (!first) {
				r.coefficients.get(1).x += globalShift.x;
				r.coefficients.get(1).y += globalShift.y;
			} else {
				first = false;
			}
		}
	...
	public TestFractal() {
		...
		functions = new Function[] { new IterativeFunction(this), new NormalizedFunction(this),
				...
				new TestFunction(this), new DistanceEstimator(this) };
...
//			Complex dsw1 = new Complex(0, 0);
			for (Region region : regions) {
				Complex omega1 = region.omega(q); // omega+1
				S = S.add(omega1.inverse());
//				if (usingDerivative) {
//					Complex d_omega1 = region.dOmega(q, dq); // omega'+1
//					dsw1 = dsw1.add(d_omega1.divide(omega1.square()));
//				}
			}
			Complex Omega = S.inverse(); // Omega
			q = q.multiply(Omega); // z = z*Omega

//			if (usingDerivative) {
//				Complex dOmega = dsw1.divide(S.square()); // Omega'
//				dq = Omega.add(q.multiply(dOmega)); // dz = Omega + z*Omega'
//			}
			//
		}
	...
	private static class Region {
		...
		private Complex dOmega(Complex q, Complex dq) {
			Complex dOmega = new Complex(0, 0);

			for (int i = 0; i < r.size(); i++) {
				Complex term = dq.subtract(r.get(i)); // (z'-r)
				for (int j = 0; j < r.size(); j++) {
					if (i != j)
						term = term.multiply(q.subtract(r.get(j))); // (z-r)...
				}
				dOmega = dOmega.add(term);
			}

			if (coefficients.size() > 0)
				dOmega = dOmega.multiply(realCoefficient(0).power(-r.size()));
			return dOmega.add(new Complex(1, 0));
		}
