...
public class PotentialShip extends Fractal {
	...
	public String getTip() {
		return "<html>The burning ship generated using an electrostatic approximation. <br>This allows smooth pictures but longer generating times. <br>Not great for deep zooms.</html>";
	}
