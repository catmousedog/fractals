...
public abstract class PotentialFractal extends Fractal {

	public PotentialFractal(Settings settings) {
		super(settings);
	}
	
	protected PotentialFractal(Settings settings, int iterations, LinearTransform transform, Location[] locations,
			double K) {
